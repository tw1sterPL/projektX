...
namespace KoloTumak.Intranet.Controllers
{
    public class AboutsController : Controller
    {
        ...
        public AboutsController(KoloTumakContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdAbout,Title,Description")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAbout,Title,Description")] About about)
        {
            if (id != about.IdAbout)
            {
                return NotFound();
        ...
        {
            return _context.About.Any(e => e.IdAbout == id);
        }
    }
}
