...
namespace KoloTumak.Intranet.Controllers
{
    public class NewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdNews,IdPosition,DateStart,NameSurnameAdd,Contents")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdNews,IdPosition,DateStart,NameSurnameAdd,Contents")] News news)
        {
            if (id != news.IdNews)
            {
                return NotFound();
